...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTest
    {
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "wissman77@gmail.com", ZipCode = "449150" });
            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("wissman77@gmail.com", "Forms"), null);
